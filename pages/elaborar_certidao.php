      ...
      <form id="certidaoForm">
        ...
        <div class="form-group">
            ...
            <select name="tipo" id="tipo"  onchange="exibeCampos()" required>
                <option value="" disabled selected>Escolha o tipo de certidão</option>
        ...
        <!-- Teste para Criação de Certidões-->
        ...
        <fieldset class="campo_oculto" id="comprovacao_endereco">
          ...
          <div class="form-group">
              ...
              <div class="editor">
                <textarea name="endereco_atual" id="endereco_atual"></textarea>
              </div>
          </div>

        </fieldset>

        <fieldset class="campo_oculto" id="comprovacao_pagamento_itiv">
          ...
          <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="date" name="data_lancamento_itiv" id="data_lancamento_itiv">
            </div>

            <div class="form-group">
                <label for="valor_itiv">Valor do ITIV:</label>
                <!-- <input type="number" name="valor_itiv" id="valor_itiv" step="0.01"> -->
                <input type="text" name="valor_itiv" id="valor_itiv"  oninput="filtrarNumeros(this)">
            </div>
          ...
          <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="number" name="aliquota" id="aliquota" step="0.01">
            </div>

            <div class="form-group">
                <label for="valor_transacao">Valor da Transação:</label>
                <!-- <input type="number" name="valor_transacao" id="valor_transacao" step="0.01"> -->
                 <input type="text" name="valor_transacao" id="valor_transacao"  oninput="filtrarNumeros(this)">
            </div>
          ...
          <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="number" name="dam" id="dam">
            </div>

            <div class="form-group">
                <label for="data_pagamento_itiv">Data de Pagamento do ITIV:</label>
                <input type="date" name="data_pagamento_itiv" id="data_pagamento_itiv">
            </div>
          ...
          <div class="form-group">
              ...
              <input type="text" name="nome_transmitente" id="nome_transmitente">
          </div>
          ...
          <div class="form-group">
              ...
              <input type="text" name="nome_adquirente" id="nome_adquirente">
          </div>
        ...
        <fieldset class="campo_oculto" id="valor_venal">
          <legend><b>Valor Venal</b></legend>

          <div class="form-group">
              <label for="valor_venda">Valor do Imóvel:</label>
              <!-- <input type="number" name="valor_venda" id="valor_venda" step="0.01"> -->
               <input type="text" name="valor_venda" id="valor_venda"  oninput="filtrarNumeros(this)">
          </div>
        ...
        <div class="form-group">
          ...
          <input type="date" name="data_certidao" id="data_certidao"></input>
        </div>

        <div class="form-group">
          <label for="informacoes_adicionais">Informações Adicionais</label>
          <div class="editor"><textarea name="informacoes_adicionais" id="informacoes_adicionais" rows="3"></textarea></div>
        </div>
