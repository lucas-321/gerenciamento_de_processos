      ...
      <form id="certidaoForm">
        ...
        <fieldset>
          ...
          <div class="form-group campo_oculto" id="dados_visita">
              ...
              <label for="matricula_fiscal">Matrícula do Fiscal:</label>
        ...
        <div class="form-group">
          ...
          <textarea name="info_adicionais" id="info_adicionais" rows="3" required></textarea>
        </div>
            ...
            <?php 
                ...
                if(mysqli_num_rows($result) > 0) {
                    ...
                    while($dados = mysqli_fetch_assoc($result)){
                        echo "<option value='$dados[id]'>$dados[sigla]</option>";
                    }
