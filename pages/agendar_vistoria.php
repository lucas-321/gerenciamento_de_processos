...
<body>
  ...
  <div class="content">
    ...
    <div class="form-model">
      ...
      <form id="certidaoForm">
        ...
        <span style="width: 100%; text-align: center; margin: 1rem; border-bottom: 1px solid #000;"><h3>Agendar Visita</h3></span>

        <input type="hidden" name="processo" value="<?php echo $_POST['id']; ?>">

        <div class="form-group">
          <label for="data_visita">Informe a Data:</label>
          <input type="date" name="data_visita" id="data_visita"></input>
        </div>
  ...
  <script>
    ...
    fetch("../api/agendar_vistoria.php", {
        method: "POST",
        body: formData
    })
    .then(async res => {
